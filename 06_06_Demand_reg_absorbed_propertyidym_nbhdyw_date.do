...
timer on 1
reghdfe price lprice price_per_person lprice_per_person demand qdemand $ALL_CONTROLS , a(propertyid#ym nbhd#yw date) cache(save, keep(propertyid date nbhd))
timer off 1
timer list 
