...
timer on 1
reghdfe price lprice price_per_person lprice_per_person $ALL_CONTROLS ex_*, a(propertyid#yw nbhd#date) cache(save)
timer off 1
timer list 
...
esttab model_set_A_* using "05_03_Price_reg_absorbed_propertyidyw_nbhddate_set_A.csv", replace ///
	se /// 
...
esttab model_set_B_* using "05_03_Price_reg_absorbed_propertyidyw_nbhddate_set_B.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_C_* using "05_03_Price_reg_absorbed_propertyidyw_nbhddate_set_C.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_D_* using "05_03_Price_reg_absorbed_propertyidyw_nbhddate_set_D.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_E_* using "05_03_Price_reg_absorbed_propertyidyw_nbhddate_set_E.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
