...
use "Y:\agrajg\Research\Paper1_demand_stata\53_01_Table_Data_Rental_Supply_Days.dta", clear
*2015
outreg2 using "Y:\agrajg\Research\Paper1_demand_stata\54_01_Table_Rental_Supply_Days" if year == 2015 & stats_name  == "rsd", sum(detail) eqkeep(N mean sd p5 p50 p95) cttop(2015) /// 
	groupvar(	/// 
				stats_value ///
...
*2016
outreg2 using "Y:\agrajg\Research\Paper1_demand_stata\54_01_Table_Rental_Supply_Days" if year == 2016 & stats_name  == "rsd", sum(detail) eqkeep(N mean sd p5 p50 p95) cttop(2016) /// 
	groupvar(	/// 
				stats_value ///
				\underline{\textbf{Space-Type}} stats_value_ltype1 stats_value_ltype2 stats_value_ltype3 ///
				\underline{\textbf{Property-Type}} stats_value_ptype1 stats_value_ptype2 stats_value_ptype3 stats_value_ptype4 ///
...
copy "Y:\agrajg\Research\Paper1_demand_stata\54_01_Table_Rental_Supply_Days.tex" "Z:\Paper1_Output\54_01_Table_Rental_Supply_Days.tex" , replace
*-------------------------------------------------------------------------------
*-------------------------------------------------------------------------------
* Number of days a rental is Booked in the market
use "Y:\agrajg\Research\Paper1_demand_stata\53_01_Table_Data_Rental_Booked_Days.dta", clear
*2015
outreg2 using "Y:\agrajg\Research\Paper1_demand_stata\54_01_Table_Rental_Booked_Days" if year == 2015 & stats_name  == "rbd", sum(detail) eqkeep(N mean sd p5 p50 p95) cttop(2015) /// 
	groupvar(	/// 
				stats_value ///
				\underline{\textbf{Space-Type}} stats_value_ltype1 stats_value_ltype2 stats_value_ltype3 ///
				\underline{\textbf{Property-Type}} stats_value_ptype1 stats_value_ptype2 stats_value_ptype3 stats_value_ptype4 ///
...
*2016
outreg2 using "Y:\agrajg\Research\Paper1_demand_stata\54_01_Table_Rental_Booked_Days" if year == 2016 & stats_name  == "rbd", sum(detail) eqkeep(N mean sd p5 p50 p95) cttop(2016) /// 
	groupvar(	/// 
				stats_value ///
				\underline{\textbf{Space-Type}} stats_value_ltype1 stats_value_ltype2 stats_value_ltype3 ///
				\underline{\textbf{Property-Type}} stats_value_ptype1 stats_value_ptype2 stats_value_ptype3 stats_value_ptype4 ///
...
copy "Y:\agrajg\Research\Paper1_demand_stata\54_01_Table_Rental_Booked_Days.tex" "Z:\Paper1_Output\54_01_Table_Rental_Booked_Days.tex" , replace
*-------------------------------------------------------------------------------
