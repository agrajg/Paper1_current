...
reghdfe qdemand qdemand_l1 qdemand_l2  ///
	...
	a(propertyid date nbhd#yw nbhd#dow) vce(cluster propertyid) stages(first ols reduced acid)
...
esttab reghdfe_first1 using "08_04_Demand_reg_First_Stage.tex",  replace ///
	se /// 
