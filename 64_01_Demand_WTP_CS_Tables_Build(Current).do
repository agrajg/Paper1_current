...
use "Y:\agrajg\Research\Paper1_demand_stata\63_01_Table_Data_Total_Counsumer_Surplus.dta", clear
*2015
outreg2 using "Y:\agrajg\Research\Paper1_demand_stata\64_01_Table_Total_Counsumer_Surplus" if year == 2015 & stats_name  == "CS_exist_actual", sum(detail) eqkeep(N mean sd p5 p50 p95) cttop(2015) /// 
	groupvar(	/// 
				stats_value ///
...
*2016
outreg2 using "Y:\agrajg\Research\Paper1_demand_stata\64_01_Table_Total_Counsumer_Surplus" if year == 2016 & stats_name  == "CS_exist_actual", sum(detail) eqkeep(N mean sd p5 p50 p95) cttop(2016) /// 
	groupvar(	/// 
				stats_value ///
				\underline{\textbf{Space-Type}} stats_value_ltype1 stats_value_ltype2 stats_value_ltype3 ///
				\underline{\textbf{Property-Type}} stats_value_ptype1 stats_value_ptype2 stats_value_ptype3 stats_value_ptype4 ///
...
copy "Y:\agrajg\Research\Paper1_demand_stata\64_01_Table_Total_Counsumer_Surplus.tex" "Z:\Paper1_Output\64_01_Table_Total_Counsumer_Surplus.tex" , replace
*-------------------------------------------------------------------------------
