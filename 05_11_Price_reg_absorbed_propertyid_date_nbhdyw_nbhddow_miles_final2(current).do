...
timer on 1
reghdfe ladj_price_per_person ladj_price_per_person100 $ALL_CONTROLS N_inmile_* , /// 
...
esttab model_set_A* using "05_11_Price_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final2.tex", replace ///
	se /// 
...
esttab model_set_A* using "05_11_Price_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final2.csv", replace ///
	se /// 
	title("\textsc{Impact On Prices}") ///
	b(a2) ///
	order(N_inmile_*) ///
