...
twoway (scatter count_propertyid date, sort mcolor(blue)) (lfit count_propertyid date, lcolor(navy)) (scatter count_propertyid date if ((week == 52)|(usopendummy==1)) , sort mcolor(ltblue) msize(large) msymbol(circle_hollow)), ytitle(Number of rentals) ylabel(#5, ticks) xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(off) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (scatter mean_mc date, sort mcolor(blue)) (lfit mean_mc date, lcolor(navy)) (scatter mean_mc date if ((week == 52)|(usopendummy==1)), sort mcolor(ltblue) msize(large) msymbol(circle_hollow)), ytitle(Average Marginal Cost ($)) ylabel(#5, ticks) xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(off) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (scatter mean_markup date, sort mcolor(blue)) (lfit mean_markup date, lcolor(navy)) (scatter mean_markup date if ((week == 52)|(usopendummy==1)), sort mcolor(ltblue) msize(large) msymbol(circle_hollow)), ytitle(Average Markup (%)) ylabel(#5, ticks) xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(off) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (scatter mean_PS_exist_actual date, sort mcolor(blue)) (lfit mean_PS_exist_actual date, lcolor(navy)) (scatter mean_PS_exist_actual date if ((week == 52)|(usopendummy==1)), sort mcolor(ltblue) msize(large) msymbol(circle_hollow)), ytitle(Average Producer Surplus ($)) ylabel(#5, ticks) xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(off) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)	
...
twoway (scatter sum_PS_exist_actual date, sort mcolor(blue)) (lfit sum_PS_exist_actual date, lcolor(navy)) (scatter sum_PS_exist_actual date if ((week == 52)|(usopendummy==1)), sort mcolor(ltblue) msize(large) msymbol(circle_hollow)), ytitle(Total Producer Surplus (1M $)) ylabel(#5, ticks) xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(off) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
gen double ltype3 = 1 if listingtype == "Shablue room"
...
label var var_ltype3 "Shablue Room"
*Propertytype
...
label var var_ntype7 "Cobble Hill, Carroll Gardens, blue Hook, Park Slope"
