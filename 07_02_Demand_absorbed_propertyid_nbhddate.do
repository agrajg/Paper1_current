...
// 	a(FE_propertyid = i.propertyid FE_nbhd_date = i.nbhd#i.date) cache(save, keep(propertyid nbhd date))
...
reghdfe qdemand  p_age h_age p_dayshosting h_dayshosting p_daysbooked h_daysbooked p_guestcount h_guestcount ///
	(lprice_per_person = i.prod_week1 i.prod_week2 i.prod_week3 i.prod_week4 i.prod_week5), /// 
	a(FE_propertyid = i.propertyid FE_nbhd_date = i.nbhd#i.date)
...
timer on 3
estfe model_set_*  ///
	, labels(propertyid "Property FE"  nbhd#date "Neighborhood-Date FE")
return list

esttab model_set_* using "07_02_Demand_reg_absorbed_propertyid_nbhddate.csv", replace ///
	se /// 
