...
order N_inmile_0_500 N_inmile_0_1000 N_inmile_0_2000 N_inmile_0_5000 N_inmile_0_10000 N_inmile_0_20000 N_inmile_500_1000 N_inmile_1000_2000 N_inmile_2000_5000 N_inmile_5000_10000 N_inmile_10000_20000, after (qdemand)

timer on 1
reghdfe qdemand  $ALL_CONTROLS N_inmile_* , /// 
...
esttab model_set_A* using "05_12_Quantity_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final2.tex", replace ///
	se /// 
...
esttab model_set_A* using "05_12_Quantity_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final2.csv", replace ///
	se /// 
	title("\textsc{Impact On Quantity}") ///
	b(a2) ///
	order(N_inmile_*) ///
