...
twoway (scatter count_rentals date, sort mcolor(blue)) (lfit count_rentals date, lcolor(navy)) (scatter count_rentals date if ((week == 52)|(usopendummy==1)), sort mcolor(ltblue) msize(large) msymbol(circle_hollow)) (scatter count_hosts date, sort msymbol(square_hollow) mcolor(red)) (lfit count_hosts date, lcolor(maroon)) (scatter count_hosts date if ((week == 52)|(usopendummy==1)), sort mcolor(yellow) msize(large) msymbol(square_hollow)),  xline(20393, lpattern(vshortdash)) ytitle("Count (1000 Rentals)") xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(on order(1 "Rental" 4 "Host") size(medium) position(10) ring(0)) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (scatter total_capacity date, sort msymbol(smcircle_hollow) mcolor(blue)) (scatter total_capacity date if ((week == 52)|(usopendummy==1)), sort mcolor(ltblue) msymbol(circle_hollow)) (scatter sum_capacity1 date, sort msymbol(smsquare_hollow) mcolor(red)) (scatter sum_capacity1 date if ((week == 52)|(usopendummy==1)), sort mcolor(yellow) msymbol(square_hollow)), xline(20393, lpattern(vshortdash)) ytitle(Capacity (1000 persons)) xtitle(Date) xlabel(#10, angle(forty_five) grid) legend(on order(1 "Total" 3 "Booked") size(medium) position(10) ring(0)) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (line p50_adj_ppp date, sort lcolor(navy)) (line p25_adj_ppp date, lpattern(dash) lcolor(blue)) (line p75_adj_ppp date, sort lpattern(dash) lcolor(blue)) , ytitle(Price per person ($)) xtitle(Date) xline(20393, lpattern(shortdash_dot)) xlabel(#10, angle(forty_five) grid) legend(on order(1 "Median" 2 "First/Third Quartile") cols(2) position(1) ring(0)) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (scatter frac date, sort) (lfit frac date), ytitle(Capacity (Number of persons) booked) xtitle(Date) xline(20393, lpattern(shortdash_dot)) xlabel(#10, angle(forty_five) grid) legend(off) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (line share_total_revenue date, sort lcolor(blue)), ytitle(Share (%)) xtitle(Date) xline(20393, lpattern(vshortdash)) xlabel(#10, angle(forty_five) grid) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (line HHI_total_revenue date, sort lcolor(blue)), ytitle(HHI) xtitle(Date) xline(20393, lpattern(vshortdash)) xlabel(#10, angle(forty_five) grid) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
...
twoway (line lostrental date, sort lcolor(maroon)), ytitle("Count (1000 Rentals)") xtitle(Date) xline(20393, lpattern(shortdash)) xlabel(#10, angle(forty_five) grid) scheme(tufte) xsize(5) ysize(1.5) scale(1.5)
