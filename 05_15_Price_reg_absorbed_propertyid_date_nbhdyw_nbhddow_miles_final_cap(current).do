...
global ALL_CONTROLS p_age h_age p_daysbooked h_daysbooked p_guestcount h_guestcount i.prod_week1 i.prod_week2 i.prod_week3 i.prod_week4 i.prod_week5
order N_cap_inmile_0_500 N_cap_inmile_0_1000 N_cap_inmile_0_2000 N_cap_inmile_0_5000 N_cap_inmile_0_10000 N_cap_inmile_0_20000 N_cap_inmile_500_1000 N_cap_inmile_1000_2000 N_cap_inmile_2000_5000 N_cap_inmile_5000_10000 N_cap_inmile_10000_20000, after (ladj_price_per_person)

timer on 1
reghdfe ladj_price_per_person ladj_price_per_person100 p_age h_age p_daysbooked h_daysbooked p_guestcount h_guestcount c.capacity#prod_week1 i.prod_week1 i.prod_week2 i.prod_week3 i.prod_week4 i.prod_week5 c.capacity#prod_week2 c.capacity#prod_week3 c.capacity#prod_week4 c.capacity#prod_week5 N_cap_inmile_* , /// 
...
*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
reghdfe ladj_price_per_person100 p_age h_age p_daysbooked h_daysbooked p_guestcount h_guestcount i.prod_week1 i.prod_week2 i.prod_week3 i.prod_week4 i.prod_week5 c.capacity#prod_week1 c.capacity#prod_week2 c.capacity#prod_week3 c.capacity#prod_week4 c.capacity#prod_week5 ///
	N_cap_inmile_0_500 ///
...
esttab model_set_A* using "05_15_Price_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final_cap.tex", replace ///
	se /// 
	title("\textsc{Impact On Prices}") ///
	b(a2) ///
	order(N_cap_inmile_*) ///
	label ///
...
esttab model_set_A* using "05_15_Price_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final_cap.csv", replace ///
	se /// 
	title("\textsc{Impact On Prices}") ///
	b(a2) ///
	order(N_cap_inmile_*) ///
