# Rscript "y:\agrajg\Research\Paper1_demand_stata\11_04_Solver2_part_1(current).R"
...
df <- df %>% mutate(OOS_MC_xbd1 = if_else(OOS_MC_xbd2 > 0, OOS_MC_xbd2,0))
df
...
df %>%
  ...
  write.csv( file = "11_04_solved_nonlinear_computed_price_oos2_part_31.csv", row.names=TRUE , na = "")
