...
ivregress 2sls  qdemand qdemand_l1 qdemand_l2  ///
	p_age h_age p_daysbooked h_daysbooked p_guestcount h_guestcount ///
	(ladj_price_per_person = i.prod_week1 i.prod_week2 i.prod_week3 i.prod_week4 i.prod_week5) , vce(cluster propertyid)
...
esttab model_1 model_2 model_3 model_4 model_5 model_6 model_7 model_8 using "08_02_Demand_reg_absorbed_propertyid_date_nbhdyw_nbhddow.tex",  replace ///
	se /// 
	title("\textsc{Rental Demand Estimates}") ///
	b(a2) ///
...
//
// save "08_02_Demand_elasticity_mc2.dta", replace 
