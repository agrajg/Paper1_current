...
esttab model_set_A* using "05_10_Price_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final.tex", replace ///
	se /// 
...
esttab model_set_A* using "05_10_Price_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final.csv", replace ///
	se /// 
	title("\textsc{Impact On Prices}") ///
	b(a2) ///
	order(N_inmile_*) ///
