...
timer on 1
reghdfe price lprice price_per_person lprice_per_person $ALL_CONTROLS ex_*, a(propertyid#ym nbhd#yw dow) cache(save)
timer off 1
timer list 
...
reghdfe lprice_per_person /// 
	ex_dd_0_500  ///
	$ALL_CONTROLS /// 
	, a(propertyid#ym nbhd#yw dow) cache(use)
...
esttab model_set_A_* using "05_05_Price_reg_absorbed_propertyidym_nbhdyw_dow_set_A.csv", replace ///
	se /// 
...
esttab model_set_B_* using "05_05_Price_reg_absorbed_propertyidym_nbhdyw_dow_set_B.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_C_* using "05_05_Price_reg_absorbed_propertyidym_nbhdyw_dow_set_C.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_D_* using "05_05_Price_reg_absorbed_propertyidym_nbhdyw_dow_set_D.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_E_* using "05_05_Price_reg_absorbed_propertyidym_nbhdyw_dow_set_E.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
