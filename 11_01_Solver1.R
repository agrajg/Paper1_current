...
ptm <- proc.time()
MC_demand <- read.csv(file = "10_01_For_non_linear_price_computation.csv", header = TRUE)
save(MC_demand, file = "11_01_For_non_linear_price_computation.RData")
proc.time() - ptm

load(file = "11_01_For_non_linear_price_computation.RData")
...
df %>%
  ...
  write.csv( file = "11_01_solved_nonlinear_computed_price_oos1.csv", row.names=TRUE , na = "")
