...
esttab model_set_A_* using "05_01_Price_reg_absorbed_propertyid_date_nbhdyw_set_A.tex", replace booktabs ///
	se /// 
...
esttab model_set_A_* using "05_01_Price_reg_absorbed_propertyid_date_nbhdyw_set_A.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_B_* using "05_01_Price_reg_absorbed_propertyid_date_nbhdyw_set_B.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_C_* using "05_01_Price_reg_absorbed_propertyid_date_nbhdyw_set_C.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_D_* using "05_01_Price_reg_absorbed_propertyid_date_nbhdyw_set_D.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
...
esttab model_set_E_* using "05_01_Price_reg_absorbed_propertyid_date_nbhdyw_set_E.csv", replace ///
	se /// 
	title("Regression results - Equilibrium Prices") ///
	b(a2) ///
	order(ex_*) ///
