...
timer on 1
reghdfe qdemand  $ALL_CONTROLS N_cap_inmile_* , /// 
...
esttab model_set_A* using "05_14_Quantity_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final_cap.tex", replace ///
	se /// 
...
esttab model_set_A* using "05_14_Quantity_reg_absorbed_propertyid_date_nbhdyw_set_mile_A_final_cap.csv", replace ///
	se /// 
	title("\textsc{Impact On Quantity}") ///
	b(a2) ///
	order(N_cap_inmile_*) ///
